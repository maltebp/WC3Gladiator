...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'n00M', -98.3, 1129.3, 310.615 )
    set u = CreateUnit( p, 'n00M', -418.9, 947.6, 223.293 )
    set u = CreateUnit( p, 'n00M', -243.4, 1047.7, 121.359 )
    set u = CreateUnit( p, 'n00M', -558.8, 1051.0, 322.206 )
    set u = CreateUnit( p, 'n00M', -266.9, 812.9, 169.326 )
    set u = CreateUnit( p, 'n00M', -282.6, 1178.6, 153.901 )
    set u = CreateUnit( p, 'n00M', -604.3, 766.3, 47.638 )
endfunction
