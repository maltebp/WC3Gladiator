...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'h006', -241.4, 1052.1, 135.641 )
    set u = CreateUnit( p, 'h006', -471.3, 951.0, 220.217 )
    set u = CreateUnit( p, 'h006', -344.3, 724.6, 234.170 )
    set u = CreateUnit( p, 'h006', -98.2, 811.7, 37.574 )
    set u = CreateUnit( p, 'h006', -310.7, 954.7, 56.988 )
    set u = CreateUnit( p, 'h006', -415.6, 1112.6, 189.509 )
    set u = CreateUnit( p, 'h006', -632.8, 610.2, 154.670 )
    set u = CreateUnit( p, 'h006', -264.3, 551.4, 144.090 )
    set u = CreateUnit( p, 'h006', -162.3, 540.5, 209.175 )
    set u = CreateUnit( p, 'h006', -228.2, 729.0, 289.466 )
    set u = CreateUnit( p, 'h006', -652.6, 674.9, 153.681 )
    set u = CreateUnit( p, 'h006', -499.9, 607.3, 96.133 )
    set u = CreateUnit( p, 'h006', -499.5, 809.4, 286.247 )
    set u = CreateUnit( p, 'h006', -90.2, 879.1, 5.208 )
endfunction
