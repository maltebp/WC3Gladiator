...
function CreateAllItems takes nothing returns nothing
    ...
    call CreateItem( 'srtl', 319.9, 112.8 )
    call CreateItem( 'srtl', 355.9, 154.2 )
    call CreateItem( 'srtl', 418.3, 156.4 )
    call CreateItem( 'srtl', 375.8, 85.7 )
    call CreateItem( 'srtl', 402.5, 48.3 )
    call CreateItem( 'srtl', 346.7, 48.0 )
    call CreateItem( 'srtl', 427.6, 89.1 )
endfunction
...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hfoo', -576.9, 1120.1, 132.499 )
