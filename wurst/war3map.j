...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'opeo', 7836.3, -7739.1, 79.576 )
    set u = CreateUnit( p, 'opeo', 7437.4, -8021.1, 217.349 )
    set u = CreateUnit( p, 'opeo', 7785.8, -7971.8, 86.937 )
    set u = CreateUnit( p, 'opeo', 7627.3, -7914.8, 333.951 )
    set u = CreateUnit( p, 'opeo', 7655.1, -7674.3, 307.813 )
endfunction
