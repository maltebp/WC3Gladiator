...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'h006', 7987.5, -7702.1, 141.981 )
    set u = CreateUnit( p, 'h006', 7742.1, -7742.6, 162.141 )
    set u = CreateUnit( p, 'h006', 8114.1, -7551.3, 212.383 )
    set u = CreateUnit( p, 'h006', 7753.5, -7526.1, 356.330 )
    set u = CreateUnit( p, 'h006', 7894.3, -7876.0, 21.743 )
    set u = CreateUnit( p, 'h006', 8168.8, -7783.9, 28.302 )
    set u = CreateUnit( p, 'h006', 7971.3, -7528.4, 246.552 )
    set u = CreateUnit( p, 'h006', 7844.1, -7694.5, 316.328 )
    set u = CreateUnit( p, 'h006', 8044.3, -7762.3, 55.186 )
    set u = CreateUnit( p, 'h006', 8038.2, -7597.0, 319.624 )
    set u = CreateUnit( p, 'h006', 7890.7, -7664.7, 144.628 )
    set u = CreateUnit( p, 'h006', 7893.7, -7710.9, 181.016 )
    set u = CreateUnit( p, 'h006', 7942.3, -7846.2, 64.865 )
    set u = CreateUnit( p, 'h006', 8044.1, -7656.5, 58.812 )
    set u = CreateUnit( p, 'h006', 7951.5, -7571.9, 85.509 )
    set u = CreateUnit( p, 'h006', 8211.9, -7528.6, 228.380 )
    set u = CreateUnit( p, 'h006', 8136.3, -7459.0, 331.490 )
    set u = CreateUnit( p, 'h006', 7875.5, -7385.6, 173.326 )
    set u = CreateUnit( p, 'h006', 7782.3, -7408.1, 112.218 )
    set u = CreateUnit( p, 'h006', 7626.3, -7489.6, 209.834 )
    set u = CreateUnit( p, 'h006', 7717.6, -7912.9, 274.491 )
    set u = CreateUnit( p, 'h006', 7888.6, -7933.7, 50.780 )
    set u = CreateUnit( p, 'h006', 8155.7, -7848.5, 107.834 )
    set u = CreateUnit( p, 'h006', 8213.0, -7818.1, 15.722 )
    set u = CreateUnit( p, 'h006', 8305.8, -7639.4, 132.851 )
    set u = CreateUnit( p, 'h006', 8169.3, -7546.0, 339.686 )
    set u = CreateUnit( p, 'h006', 7924.2, -7607.2, 225.534 )
    set u = CreateUnit( p, 'h006', 7878.0, -7620.3, 177.292 )
    set u = CreateUnit( p, 'h006', 7608.3, -7531.7, 180.819 )
    set u = CreateUnit( p, 'h006', 7582.6, -7594.5, 216.547 )
endfunction
