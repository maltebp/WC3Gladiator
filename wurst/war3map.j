...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'hmpr', -7889.9, -8349.6, 309.582 )
endfunction
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_Arena_Visibility = Rect( -1024.0, -672.0, 1280.0, 1632.0 )
    set gg_rct_Arena_Spawn1 = Rect( -512.0, -96.0, 736.0, 1120.0 )
endfunction
