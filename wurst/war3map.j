...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'h006', -96.3, 866.0, 124.787 )
    set u = CreateUnit( p, 'h006', -310.2, 892.4, 291.333 )
    set u = CreateUnit( p, 'h006', -314.1, 622.2, 288.180 )
    set u = CreateUnit( p, 'h006', -120.1, 649.6, 39.662 )
    set u = CreateUnit( p, 'h006', -104.5, 708.3, 151.440 )
    set u = CreateUnit( p, 'h006', -168.8, 721.3, 104.582 )
    set u = CreateUnit( p, 'h006', -505.5, 758.4, 265.229 )
    set u = CreateUnit( p, 'h006', -132.0, 1022.3, 325.755 )
    set u = CreateUnit( p, 'h006', -140.9, 764.0, 222.183 )
    set u = CreateUnit( p, 'h006', -363.7, 713.2, 333.434 )
    set u = CreateUnit( p, 'h006', -190.1, 592.9, 96.254 )
    set u = CreateUnit( p, 'h006', -180.1, 484.3, 187.971 )
    set u = CreateUnit( p, 'h006', -383.6, 611.8, 35.992 )
endfunction
