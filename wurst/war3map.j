...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'n00C', -76.6, 1240.5, 259.857 )
    call SetUnitColor( u, ConvertPlayerColor(12) )
    set u = CreateUnit( p, 'n00C', -485.1, 1016.2, 286.290 )
    call SetUnitColor( u, ConvertPlayerColor(12) )
    set u = CreateUnit( p, 'n00C', -322.3, 1271.7, 8.701 )
    call SetUnitColor( u, ConvertPlayerColor(12) )
endfunction
