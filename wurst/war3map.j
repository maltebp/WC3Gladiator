...
function CreateNeutralPassive takes nothing returns nothing
    ...
    call SetUnitColor( gg_unit_n00K_0002, ConvertPlayerColor(0) )
    set u = CreateUnit( p, 'n001', -8128.0, -8000.0, 270.000 )
    set gg_unit_n003_0015 = CreateUnit( p, 'n003', -8448.0, -8576.0, 270.000 )
    call SetUnitColor( gg_unit_n003_0015, ConvertPlayerColor(0) )
    set gg_unit_n002_0017 = CreateUnit( p, 'n002', -8256.0, -8704.0, 270.000 )
    call SetUnitColor( gg_unit_n002_0017, ConvertPlayerColor(0) )
endfunction
