...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'Ofar', -8004.2, -8474.6, 9.591 )
    set u = CreateUnit( p, 'Oshd', -7829.4, -8684.5, 306.308 )
    set u = CreateUnit( p, 'ogru', -8055.9, -8627.8, 136.125 )
    set u = CreateUnit( p, 'ogru', -7935.1, -8618.1, 158.746 )
    set u = CreateUnit( p, 'ogru', -8016.4, -8743.7, 51.769 )
endfunction
