...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'h006', -150.2, 1018.6, 159.636 )
    set u = CreateUnit( p, 'h006', -492.3, 988.9, 105.197 )
    set u = CreateUnit( p, 'h006', -255.4, 794.7, 150.023 )
    set u = CreateUnit( p, 'h006', -162.4, 789.1, 48.056 )
    set u = CreateUnit( p, 'h006', -180.4, 986.9, 358.934 )
    set u = CreateUnit( p, 'h006', -328.9, 1021.5, 45.990 )
    set u = CreateUnit( p, 'h006', -409.9, 811.1, 207.055 )
    set u = CreateUnit( p, 'h006', -506.6, 691.8, 149.803 )
    set u = CreateUnit( p, 'h006', -355.5, 908.7, 40.826 )
    set u = CreateUnit( p, 'h006', -260.0, 656.6, 33.476 )
    set u = CreateUnit( p, 'h006', -122.1, 914.3, 294.223 )
    set u = CreateUnit( p, 'h006', -485.7, 834.6, 190.717 )
endfunction
