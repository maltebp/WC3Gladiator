...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'O000', 8160.7, -8263.3, 256.790 )
...
function CreateUnitsForPlayer20 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'n00L', -165.4, 1002.7, 259.666 )
    set u = CreateUnit( p, 'n00L', -380.8, 766.7, 2.420 )
endfunction
