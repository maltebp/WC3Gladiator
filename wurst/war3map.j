...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'O005', 173.7, 335.9, 240.762 )
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'h006', -337.8, 1122.3, 18.502 )
    set u = CreateUnit( p, 'h006', -143.2, 860.1, 72.633 )
    set u = CreateUnit( p, 'h006', -431.4, 803.5, 352.859 )
    set u = CreateUnit( p, 'h006', -510.9, 1116.5, 191.245 )
    set u = CreateUnit( p, 'h006', -383.3, 1188.2, 236.389 )
    set u = CreateUnit( p, 'h006', -86.5, 1094.9, 303.759 )
    set u = CreateUnit( p, 'h006', -98.3, 979.4, 66.964 )
    set u = CreateUnit( p, 'h006', -279.6, 877.3, 91.266 )
    set u = CreateUnit( p, 'h006', -692.1, 903.0, 23.424 )
    set u = CreateUnit( p, 'h006', -709.6, 854.1, 242.575 )
    set u = CreateUnit( p, 'h006', -577.0, 696.4, 351.584 )
    set u = CreateUnit( p, 'h006', -375.6, 984.3, 355.408 )
    set u = CreateUnit( p, 'h006', -464.5, 1036.5, 267.481 )
    set u = CreateUnit( p, 'h006', -488.7, 985.9, 179.907 )
    set u = CreateUnit( p, 'h006', -495.0, 816.5, 305.737 )
    set u = CreateUnit( p, 'h006', -525.1, 730.2, 226.106 )
    set u = CreateUnit( p, 'h006', -352.7, 690.8, 111.207 )
    set u = CreateUnit( p, 'h006', -282.4, 689.8, 144.980 )
    set u = CreateUnit( p, 'h006', -283.6, 734.9, 270.371 )
    set u = CreateUnit( p, 'h006', -317.8, 831.8, 353.386 )
    set u = CreateUnit( p, 'h006', -342.2, 882.2, 149.913 )
    set u = CreateUnit( p, 'h006', -195.0, 1128.6, 36.893 )
    set u = CreateUnit( p, 'h006', -183.4, -206.1, 144.980 )
endfunction
